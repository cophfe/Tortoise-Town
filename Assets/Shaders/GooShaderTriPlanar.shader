...
Shader "GooShader"
{
	Properties
	{
		...
		[ASEEnd]_Texture2("Texture 2", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float simplePerlin2D183 = snoise( float2( 0,0 ) );
						 ...
						 ) : SV_Target
			{
				...
				float4 temp_cast_5 = (( 1.0 - temp_output_29_0 )).xxxx;
				float4 _EmissionColour_Instance = UNITY_ACCESS_INSTANCED_PROP(GooShader,_EmissionColour);
				float4 temp_output_127_0 = ( ( temp_output_81_0 - temp_cast_5 ) + ( _EmissionColour_Instance * temp_output_32_0 ) );
				...
				float3 Albedo = ( 0 * looks202 ).rgb;
				float3 Normal = ( unpack101 * 0 );
				float3 Emission = ( worldProjection236 * temp_output_127_0 ).rgb;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 _EmissionColour_Instance = UNITY_ACCESS_INSTANCED_PROP(GooShader,_EmissionColour);
				float4 temp_output_127_0 = ( ( temp_output_81_0 - temp_cast_3 ) + ( _EmissionColour_Instance * temp_output_32_0 ) );
...
/*ASEBEGIN
Version=18921
1955;29;1920;989;-1650.726;1514.073;1;True;False
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;183;-4870.672,-2001.681;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;229;63.9718,-5106.197;Inherit;True;Property;_Texture0;Texture 0;16;0;Create;True;0;0;0;False;0;False;94ce471624c7e574da1e212a0da0b78e;94ce471624c7e574da1e212a0da0b78e;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;230;204.1608,-4721.004;Inherit;True;Property;_Texture1;Texture 1;17;0;Create;True;0;0;0;False;0;False;94ce471624c7e574da1e212a0da0b78e;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;232;477.3962,-4194.562;Inherit;True;Property;_Texture2;Texture 2;18;0;Create;True;0;0;0;False;0;False;94ce471624c7e574da1e212a0da0b78e;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.GetLocalVarNode;237;2447.251,-1204.34;Inherit;False;236;worldProjection;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;234;2200.649,-1043.46;Inherit;False;202;looks;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;227;2601.936,-1144.312;Inherit;True;2;2;0;OBJECT;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;127;-696.0375,-395.7288;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;240;-525.2738,-1243.073;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;OBJECT;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=570E5F685AF7364ABFC34E3E3CB0E4B5C2B686D9