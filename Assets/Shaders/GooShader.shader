	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 break22_g4 = ( v.texcoord.xy * float2( 1,1 ) );
				float2 texCoord188 = v.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 center45_g6 = float2( 0.5,0.5 );
				float2 delta6_g6 = ( texCoord188 - center45_g6 );
				float angle10_g6 = ( length( delta6_g6 ) * 5.0 );
				...
				float temp_output_9_0_g4 = ( ( break22_g4.y / 0.25 ) - (sin( ( ( break22_g4.x / appendResult44_g6.x ) * TWO_PI ) )*0.5 + 0.5) );
				float temp_output_5_0_g4 = ( abs( ( temp_output_9_0_g4 - round( temp_output_9_0_g4 ) ) ) * 2.0 );
				float temp_output_3_0_g5 = ( temp_output_5_0_g4 - 0.5 );
				...
				float temp_output_190_0 = ( saturate( ( temp_output_3_0_g5 / 0 ) ) * ( smoothstepResult48 + smoothstepResult44 ) );
						 ...
						 ) : SV_Target
			{
				...
				float2 break22_g4 = ( IN.ase_texcoord7.xy * float2( 1,1 ) );
				...
				float3 unityVoronoy52 = UnityVoronoi(panner42,temp_output_159_0,_SlimeScale_Instance,uv52);
				float smoothstepResult44 = smoothstep( 0.76 , 1.0 , unityVoronoy52.x);
				float temp_output_190_0 = ( saturate( ( temp_output_3_0_g5 / fwidth( temp_output_3_0_g5 ) ) ) * ( smoothstepResult48 + smoothstepResult44 ) );
				...
				float temp_output_24_0 = ( (0.0 + (simpleNoise16 - _NoiseStrength_Instance) * (1.0 - 0.0) / (-_NoiseStrength_Instance - _NoiseStrength_Instance)) + ( 1.0 - _CutoffHeight_Instance ) );
				float temp_output_29_0 = step( ( 1.0 - WorldPosition ).y , temp_output_24_0 );
				float _EdgeWidth_Instance = UNITY_ACCESS_INSTANCED_PROP(GooShader,_EdgeWidth);
				float temp_output_32_0 = ( temp_output_29_0 - step( ( ( 1.0 - WorldPosition ).y + _EdgeWidth_Instance ) , temp_output_24_0 ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 break22_g4 = ( v.ase_texcoord.xy * float2( 1,1 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 _MainColor_Instance = UNITY_ACCESS_INSTANCED_PROP(GooShader,_MainColor);
				float2 break22_g4 = ( IN.ase_texcoord2.xy * float2( 1,1 ) );
...
/*ASEBEGIN
Version=18921
1920;0;1920;1019;4476.523;2867.057;1.3;True;False
Node;AmplifyShaderEditor.RangedFloatNode;67;-5123.375,-1728.195;Inherit;False;InstancedProperty;_AngleChangeSpeed;AngleChangeSpeed;9;0;Create;True;0;0;0;False;0;False;3;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;107;-4424.569,-1822.283;Inherit;False;InstancedProperty;_SlimeScale;SlimeScale;13;0;Create;True;0;0;0;False;0;False;5;31.37;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;189;-3613.035,-2340.358;Inherit;False;Constant;_Float3;Float 3;16;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;13;-2923.044,478.3542;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-3785.742,266.4087;Inherit;False;InstancedProperty;_CutoffHeight;CutoffHeight;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;19;-3415.029,284.6241;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;186;-2872.243,-2528.365;Inherit;True;Smooth Wave;-1;;4;45d5b33902fbc0848a1166b32106db74;1,3,2;3;17;FLOAT2;1,1;False;16;FLOAT;0.5;False;18;FLOAT;0.25;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;190;-2714.917,-2140.829;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;24;-2932.07,-256.263;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;129;-2645.901,-1592.407;Inherit;False;InstancedProperty;_SlimeShapness;SlimeShapness;14;0;Create;True;0;0;0;False;0;False;0,0;0.73,3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;80;-2754.89,-1400.567;Inherit;False;InstancedProperty;_GooSlimeColor;GooSlimeColor;6;1;[HDR];Create;True;0;0;0;False;0;False;0.1603774,0.1603774,0.1603774,0;0.8106098,0,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;83;-2060.165,-2113.241;Inherit;False;InstancedProperty;_MainColor;MainColor;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;185;-150.4629,-2161.087;Inherit;True;Noise Sine Wave;-1;;3;a6eff29f739ced848846e3b648af87bd;0;2;1;FLOAT;0;False;2;FLOAT2;-0.5,0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;56;-1293.169,-476.0995;Inherit;False;InstancedProperty;_EmissionColour;EmissionColour;5;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;16,3.183246,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=23B5AC3C616A7CB77D094A7FD5403423BE67F18E