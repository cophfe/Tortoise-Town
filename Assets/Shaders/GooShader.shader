...
Shader "GooShader"
{
	Properties
	{
		...
		[ASEEnd]_TwirlStrength("TwirlStrength", Float) = 20
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_cast_1 = (temp_output_218_0).xx;
				float2 center45_g11 = temp_cast_1;
				...
				float smoothstepResult124 = smoothstep( -0.55 , 0.38 , temp_output_190_0);
...
/*ASEBEGIN
Version=18921
1920;4;1920;1015;4390.37;2600.618;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-883.4926,-1585.398;Inherit;False;InstancedProperty;_MoveStength;MoveStength;12;0;Create;True;0;0;0;False;0;False;0.1;6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;124;-847.9208,-1822.849;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;-0.55;False;2;FLOAT;0.38;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;223;-507.0693,-1452.805;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;100;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=3A398C9C23C41094C9E975C2B1D8E0417612A143